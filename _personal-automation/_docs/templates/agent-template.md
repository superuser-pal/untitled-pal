...
- &quot;[Core principle 3 that guides this agent's decisions]&quot;</principles>
  ...
  <menu>
    ...
    <item cmd="*workflow-1" exec="{domain_root}/workflows/[workflow-name-1]/execution.md">[Workflow 1 Description]</item>
    <item cmd="*workflow-2" exec="{domain_root}/workflows/[workflow-name-2]/execution.md">[Workflow 2 Description]</item>
